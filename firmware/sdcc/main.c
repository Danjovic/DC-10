...
/*  
	...
	V0.21 - November 28, 2016 - Changed to common cathode displays
*/
...
#define _decimal_point (1<<0) // bit where dp is mapped
...
// ****** Constants ******
// const unsigned char common[4] = { 1, 2, 4, 8 }; // pins activated for common anode (prototype only)

// const unsigned char common[4] = { 4, 8, 1, 2 }; // pins activated for common anode 
const unsigned char common[4] = { ~4, ~8, ~1, ~2 }; // pins activated for common cathode
...
>>>>>>> 7d4b86d38bca72f7ac16b1f49ff93c549f728431
